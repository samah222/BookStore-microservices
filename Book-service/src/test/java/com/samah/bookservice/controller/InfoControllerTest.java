...
class InfoControllerTest {
    ...
    void shouldReturnAppInfo() throws Exception {
        when(infoService.getAppNameAndVersion()).thenReturn("This application is books and this version: v1");
        this.mockMvc.perform(get("/v1/info")).andDo(print()).andExpect(status().isOk())
                .andExpect(content().string(containsString("This application is books and this version: v1")));
    }
