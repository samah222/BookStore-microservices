...
public class OpenAPIConfig {
    ...
    public OpenAPI myOpenAPI() {
        ...
        Info info = new Info()
                .title("Bookstore - Order Service APIs")
                .version("1.0")
                .contact(contact)
                .description("These APIs exposes endpoints to manage Order-service as part of Book-store microservice project.")                 .license(mitLicense);
